...
export function SiteHeader() {
  ...
  return (
    <>
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="hidden items-center gap-1.5 rounded-sm border border-gold/40 bg-gold/10 px-4 py-2 text-sm font-semibold text-gold transition-all duration-300 hover:bg-gold hover:text-primary-foreground sm:inline-flex cursor-pointer"
            >
              Submit Tender
        ...
        >
          <nav className="flex flex-col px-4 py-2 sm:px-6">
            ...
            <button
              ...
              className="mt-3 mb-2 inline-flex items-center justify-center gap-1.5 rounded-sm bg-gold px-4 py-2.5 text-sm font-semibold text-primary-foreground cursor-pointer text-center"
            >
              Submit Tender
              <ArrowUpRight className="h-4 w-4" />
            </button>
      ...
      {/* Render the global secure bidding modal */}
      <TenderModal isOpen={isTenderOpen} onClose={() => setIsTenderOpen(false)} />
    </>
  )
}
